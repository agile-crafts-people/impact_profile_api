...
class TestAppConfiguration(unittest.TestCase):
    ...
    def test_platform_routes_registered(self):
        """Test that /api/platform routes are registered."""
    ...
    def test_all_blueprints_registered(self):
        ...
        self.assertIn('platform_routes', blueprint_names)
    ...
    def test_url_map_contains_expected_routes(self):
        ...
        self.assertTrue(any('/api/platform' in rule for rule in rules))
